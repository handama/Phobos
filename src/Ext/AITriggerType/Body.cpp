...
bool AITriggerTypeExt::PickValidHouse(HouseClass * pHouse, HouseClass * pThisHouse, int pickMode)
{
	...
	if ( !pThisHouse->IsObserver() &&
		...
		|| (pThisHouse->IsControlledByHuman() && !pThisHouse->IsAlliedWith(pHouse) && pickMode == 4)
		|| (pThisHouse->IsControlledByHuman() && pThisHouse->IsAlliedWith(pHouse) && pickMode == 5)
		|| (pThisHouse->IsControlledByHuman() && pickMode == 6)
		|| (!pThisHouse->IsControlledByHuman() && !pThisHouse->IsNeutral() && !pThisHouse->IsAlliedWith(pHouse) && pickMode == 7)
		|| (!pThisHouse->IsControlledByHuman() && !pThisHouse->IsNeutral() && pThisHouse->IsAlliedWith(pHouse) && pickMode == 8)
		|| (!pThisHouse->IsControlledByHuman() && !pThisHouse->IsNeutral() && pickMode == 9)
